  ...
  return (
    <div className="bg-gray-100 min-h-screen flex flex-col justify-center py-8 px-4">
      <div className="max-w-2xl mx-auto bg-white rounded-lg shadow-lg p-6">
        <h1 className="text-4xl font-bold text-center text-blue-600 mb-6">Terms of Use</h1>
        
        <p className="mb-6 text-gray-700 leading-relaxed">
          Welcome to <a href="https://www.alivefoundation.in" className="text-blue-500 underline" target="_blank" rel="noopener noreferrer">www.alivefoundation.in</a>. If you continue to browse and use this website, you agree to be bound by and are bound by the following terms and conditions of use, which, along with our Privacy Policy, govern your relationship with ALIVE FOUNDATION concerning this website.
        </p>

        <h2 className="text-3xl font-semibold text-gray-800 mt-6 mb-4">Terms of Use</h2>
        <p className="mb-4 text-gray-700 leading-relaxed">
          Your use of this website is subject to the following terms of use:
        </p>
        <ul className="list-disc ml-5 mb-6 text-gray-700 leading-relaxed">
