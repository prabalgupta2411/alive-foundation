  ...
  return (
    <div className="bg-gray-100 min-h-screen flex flex-col justify-center py-8 px-4">
      <div className="max-w-2xl mx-auto bg-white rounded-lg shadow-lg p-6">
        ...
        <h2 className="text-3xl font-semibold text-gray-800 mt-6 mb-4">Your Personal Information</h2>
        ...
        <h2 className="text-3xl font-semibold text-gray-800 mt-6 mb-4">Collection of Information</h2>
        <p className="mb-6 text-gray-700 leading-relaxed">
        ...
        <h2 className="text-3xl font-semibold text-gray-800 mt-6 mb-4">Use of Personal Information</h2>
        <p className="mb-6 text-gray-700 leading-relaxed">
