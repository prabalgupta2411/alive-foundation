...
const Contact = () => {
  return (
    <>
      <section className="relative z-10 overflow-hidden bg-[#F8FFFF] px-11 py-20 dark:bg-dark lg:py-[120px] md:px-20">
              ...
              <div className="relative rounded-lg bg-white p-8 shadow-lg sm:p-12">
                <form>
                  ...
                  <div>
                    <button
                      type="submit"
                      className="  w-full rounded border border-primary bg-primary p-3 text-white  hover:bg-[#3b6572] transition-transform transform hover:scale-105"
                    >
                      Send Message
                    </button>
                  </div>
