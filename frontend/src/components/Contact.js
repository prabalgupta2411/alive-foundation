...
const Contact = () => {
  return (
    <>
      <section className="relative z-10 overflow-hidden bg-white px-11 py-20 dark:bg-dark lg:py-[120px] md:px-20">
              ...
              <div className="relative rounded-lg bg-white p-8 shadow-lg dark:bg-dark-2 sm:p-12">
                <form>
                  ...
                  <div>
                    <button
                      type="submit"
                      className=" bg-blue-600 w-full rounded border border-primary bg-primary p-3 text-white transition hover:bg-opacity-90"
                    >
                      Send Message
                    </button>
                  </div>
